...
const AboutPage = () => (
  <Layout>
    ...
    <Section>
      <Title>ABOUT</Title>
      <p>Here is a list of copy-and-paste resources for conference and podcast organizers.</p>
      ...
      <Bio>
        ...
        <br />
        <br />
        He worked as an Engineering Manager at Salesforce Commerce Cloud for Commerce Search team. While in the US, he
        joined Loadsmart at an early stage, being the first front-end engineer, leading the area for five years, and
