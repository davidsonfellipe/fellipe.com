...
const TalksPage = () => (
  <Layout>
    ...
    <Section>
      ...
      <Bio>
        Davidson is a Brazilian based in Brooklyn who's working as a Lead Software Engineer at Salesforce Commerce
        Cloud.
      </Bio>
      ...
      <Bio>
        ...
        worked for some large and small companies in the US and Brazil. Currently works as a Lead Software Engineer at
      ...
      <Bio>
        ...
        <br />
        <br />
        Currently, he works as Lead Software Engineer at Salesforce Commerce Cloud, with focus on front-end development
        for Commerce Search team. While in the US, he joined Loadsmart at an early stage, being the first front-end
        engineer, leading the area for five years, being responsible for the maintenance and evolution of the
        engineering recruitment process, he also worked as an engineering manager, managing teams, roadmap, backlog and
        supporting the career growth of 2 engineering teams. While in Brazil, he worked for five years on the design,
        development, and maintenance of high scalable front-end applications for globo.com, ge.globo.com and
        sportv.globo.com. Globo is the largest media company in latin america. And also, he worked a few more years in
        projects related to web development, e-learning platforms, and mentoring in coding bootcamp-like programs. He
        already spoken in over 30 conferences about software development, and former co-organized of some conferences
        for developers: Front in BH, Front in Recife, PernambucoJS, and Rio.JS.
        <br />
        <br />
